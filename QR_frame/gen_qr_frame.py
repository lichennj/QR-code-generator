...
def iter_folder_text(qr_path):
    ...
    for file in os.listdir(qr_path):
        add_text(file)
        add_frame(file, frame) # this is the newly added feture for the DiscoverE frame
...
def add_frame(img_name, frame):
    ...
    #new_im.paste(img, (355, 427))
    new_im.paste(img, (93, 398))
